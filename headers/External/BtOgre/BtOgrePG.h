/**
 * @file BtOgrePG.h
 * @brief The part of BtOgre that handles information transfer from Bullet to
...
namespace BtOgre
{
     ...
     * @brief Access to Bullets btMotionState
     * 
    ...
    public:
        ...
        : mTransform(((node != NULL) ? BtOgre::Convert::toBullet(node->getOrientation())
