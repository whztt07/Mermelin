/**
 * @file BtOgreExtras.h
 * @brief Contains the Ogre Mesh to Bullet Shape converters.
...
namespace BtOgre
{
    ...
    /**
     * @class Convert
     * @brief Converts from and to Bullet and Ogre stuff. Pretty self-explanatory.
     */
    class Convert
    {
    public:
     ...
     * @brief Class used by the @link DebugDrawer @endlink
     */
    ...
    /**
     * @class DebugDrawer
     * @brief The link between btIDebugDraw and Ogre
     */
