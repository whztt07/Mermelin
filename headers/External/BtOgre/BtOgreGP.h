/**
 * @file BtOgreGP.h
 * @brief The part of BtOgre that handles information transfer from Ogre to
...
namespace BtOgre
{
     ...
     * @brief Enables the creation of bullet primitives like spheres, boxes, etc.
     */
    class VertexIndexToShape
    {
    public:
        ...
        btStaticPlaneShape* createPlane();
     ...
     * @brief Class for static meshes without animation.
     */
     ...
     * @brief Class for animated meshes
     */
